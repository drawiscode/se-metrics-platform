...
- 实现：仓库列表 / 仓库详情（metrics、health、activity、hotfiles、hotdirs）/ AI 问答与对话历史页面
...
| `frontend/src/main.js` | 注册 Router；路由：`/repos`、`/repos/:id`、`/ai` |
...
| `frontend/src/views/AiView.vue` | AI 问答：POST /api/ai/ask；对话历史：GET /api/ai/conversations |
